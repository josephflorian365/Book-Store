...
import pe.todotic.bookstoreapi_s3.exception.StorageException;
...
public class FileSystemStorageService implements StorageService {
    ...
    public String store(MultipartFile file) {
        ...
        try {
            ...
            throw new StorageException("Falló al almacenar el archivo " +
                    originalFilename);
        }
        return filename;
    }
    ...
    public Resource loadAsResource(String filename) {
        try {
            ...
            if (resource.exists() || resource.isReadable()) {
                ...
                throw new MediaFileNotFoundException("El archivo no ha sido encontrado:\n"
                        + filename);
            }
